...
<title>SHAW WALLACE | CAREERS</title>
...
<div class="text1" id="common_box" style="height:18px;">You are in:  <span class="text2">Careers</span> <!--/  Vision &amp; Values--></div>
<div class="text1" id="left_navi_box">
<div class="headin1" id="common_box" style="padding-bottom:10px;">Careers</div>
...
<div id="common_box" style="width:780px;">
    ...
    <div class="headin2" id="common_box" style="width:780px; padding:15px 0">Careers<br /><br />
      <span class="text">Unable to proceed... Try again.....</span></div>   
</div>
