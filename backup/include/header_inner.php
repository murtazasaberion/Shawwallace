...
<ul class="main_links">
<div id="img_thmb">
<div class="btm1 main_links" ><a href="../automotive/index.php" <?php echo main_sel_class('automotive'); ?>>AUTOMOTIVE</a> </div>
<div class="btm2 main_links" ><a href="../fmcg/index.php" <?php echo main_sel_class('fmcg'); ?>>FMCG</a></div>
<div class="btm3 main_links" ><a href="../food/index.php" <?php echo main_sel_class('food'); ?>>FOOD SERVICE</a></div>
<div class="btm5 main_links" ><a href="../industrial_solution/index.php" <?php echo main_sel_class('industrial_solution'); ?>>INDUSTRIAL SOLUTIONS</a> </div>
<div class="btm4 main_links" ><a href="../manufacturing/index.php" <?php echo main_sel_class('manufacturing'); ?>>MANUFACTURING</a> </div>
