...
<div id="common_box" style="width:780px;">
	<div id="img_box" > <img src="img/networks_img.jpg" width="780" height="250" /></div>
...
<ul id="link_options">
                    ...
                    <li><a href="#">Centralised Shipping &amp; Wharf</a></li>
...
<span class="text_globle">Situated in the main highway connecting the North and South of Colombo the Shaw Wallace Building is a modern 8 storey corporate headquarters consisting of 70,000 sq ft.. Currently Shaw Wallace occupies part of the building while the rest is tenanted by prestigious clientele.
</span>
                  	          </div>
                    	      </div>
                    	      <div class="slide slide_1">
                    	        <div style="width:780px; float:left; border-right:#999 dotted 1px; padding:0 0px 0 0;">
                    	          <span class="headin3">Shaw Wallace Warehouse</span><span class="text_globle">Located on the main highway leading to the International Airport and interlinking the North Western and southern points of Colombo as well as the second largest city of Kandy, the Shaw Wallace warehouse is a 80,000 sq ft facility on a large area of land to grow and cater to the company’s needs over the years.<br /><br />
...
Our newly instituted warehouse facility with end to end racking systems ensures capacity for better temperature controlled inventory. The multiple docking system and information system improvements also ensure faster efficient response to our customers.
                              ...
                              <div class="slide slide_3">
                    	        <div style="width:780px; float:left; border-right:#999 dotted 1px; padding:0 0px 0 0;">
                    	          <span class="headin3">Centralised Shipping and Wharf</span>
                    	          <p class="text_globle">Centralised import/export, shipping and wharf facilities are provided by Renuka Travels & Tours (Pvt) Ltd, a group company.
                    	        </div>
                    	      </div>
