...
<ul id="link_options">
                    <li><a href="#" class="active"> Automotive </a>
                    <div id="common_box" style="width:2px"><img src="img/sp_line.jpg" width="2" height="35" /></div></li>
                    <li><a href="#"> FMCG  </a>
                    <div id="common_box" style="width:2px"><img src="img/sp_line.jpg" width="2" height="35" /></div></li>
                    <li><a href="#">Food Service</a><div id="common_box" style="width:2px"><img src="img/sp_line.jpg" width="2" height="35" /></div></li>
                    	    ...
                    	    <div id="slide-container">
                    	      <div class="slide slide_0">
                    	        <div style="width:780px; float:left; border-right:#999 dotted 1px; padding:0 0px 0 0;">
                    	          <span class="headin3">Automotive Distribution Network</span>

<span class="text_globle">Our subsidiary McShaw Automotive Ltd  has a team of over 50 dedicated personnel in the automotive sector covering the segments of key accounts, nominated dealers, direct dealers, franchise car dealers, service stations, fuel stations, retailers,spare part shops, IWS(Individual workshops) and franchise workshops etc, a network spanning over 4500 customers island-wide.
</span>
                  	          </div>
                    	      </div>
                    	      <div class="slide slide_1">
                    	        <div style="width:780px; float:left; border-right:#999 dotted 1px; padding:0 0px 0 0;">
                    	          <span class="headin3">FMCG Distribution Network</span><span class="text_globle">Shaw Wallace Ceylon Ltd delivers through its nominated and direct dealer network to 56,000 outlets and indirectly to over 100,000 outlets across Sri Lanka assisted and monitored by over 100 company salesmen. Our sales force automation system enables swift response and rapid delivery. Plus our integrated Management Information System also ensures access to immediate and real time data enabling effective sales tracking. In it’s portfolio of products and agencies Shaw Wallace owns some of Sri Lanka’s premier brands which are market leaders in their respective categories.
                   	            </span> </div>
                    	      </div>
                    	      <div class="slide slide_2">
                    	        <div style="width:780px; float:left; border-right:#999 dotted 1px; padding:0 0px 0 0;">
                    	          <span class="headin3">Food Service Distribution Network</span>
                    	          <p class="text_globle">Our dedicated team of personnel for this sector service the requirements of all leading hotels. restaurants, caterers, airlines,food manufacturers, ship chandlers across the Island. We also ensure optimum storage and timely delivery and supply of all requirements.
                    	        </div>
                    	      </div>
